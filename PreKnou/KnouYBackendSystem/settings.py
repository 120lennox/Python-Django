"""
Django settings for KnouYBackendSystem project.
...
SECRET_KEY = 'django-insecure-s_7r9woj$d*dimuw!uc#xs*v8g(z6x_lh_)=u=e3f*hsr30%4@'
...
WSGI_APPLICATION = 'KnouYBackendSystem.wsgi.application'
